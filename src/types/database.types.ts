...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      design_revisions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "design_revisions_parent_design_id_fkey"
      ...
      design_task_logs: {
        Row: {
          ...
          product_id: string | null
          quantity: number
          task_type: Database["public"]["Enums"]["design_task_type"]
          unit_price: number
        }
        Insert: {
          amount?: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "design_task_logs_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["employee_id"]
          ...
          {
            foreignKeyName: "design_task_logs_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "design_task_logs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["product_id"]
      ...
      equipment_ship_logs: {
        Row: {
          ...
          from_company_id: string | null
          legacy_cutter_id: number | null
          legacy_mold_id: number | null
          legacy_ship_id: number | null
          notes: string | null
          ship_date: string
        ...
        Relationships: [
          {
            foreignKeyName: "equipment_ship_logs_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["employee_id"]
          ...
          {
            foreignKeyName: "equipment_ship_logs_equipment_id_fkey"
            columns: ["equipment_id"]
            isOneToOne: false
            referencedRelation: "equipment"
            referencedColumns: ["equipment_id"]
      ...
      equipment_status_logs: {
        Row: {
          ...
          legacy_cutter_id: number | null
          legacy_mold_id: number | null
          legacy_status_log_id: number | null
          notes: string | null
          status: string
      ...
      forming_daily_logs: {
        Row: {
          check_cutter: boolean | null
          check_frame: boolean | null
          check_heater: boolean | null
          check_mold: boolean | null
          check_plug: boolean | null
          check_stacking: boolean | null
          check_water_base: boolean | null
          created_at: string | null
          ...
          plastic_id: string | null
          product_id: string | null
          qty_ng_a: number | null
          qty_ng_b: number | null
          qty_ng_c: number | null
          qty_ng_d: number | null
          qty_ng_e: number | null
          qty_ng_f: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "forming_daily_logs_equipment_id_fkey"
            columns: ["equipment_id"]
            isOneToOne: false
            referencedRelation: "equipment"
            referencedColumns: ["equipment_id"]
          ...
          {
            foreignKeyName: "forming_daily_logs_operator_id_fkey"
            columns: ["operator_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["employee_id"]
          ...
          {
            foreignKeyName: "forming_daily_logs_plastic_id_fkey"
            columns: ["plastic_id"]
            isOneToOne: false
            referencedRelation: "plastic_master"
            referencedColumns: ["plastic_id"]
          ...
          {
            foreignKeyName: "forming_daily_logs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["product_id"]
      ...
      grinding_daily_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "grinding_daily_logs_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["employee_id"]
      ...
      inspection_daily_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "inspection_daily_logs_inspector_id_fkey"
          ...
          {
            foreignKeyName: "inspection_daily_logs_order_line_id_fkey"
          ...
          {
            foreignKeyName: "inspection_daily_logs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["product_id"]
      ...
      press_daily_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "press_daily_logs_equipment_id_fkey"
            columns: ["equipment_id"]
            isOneToOne: false
            referencedRelation: "equipment"
            referencedColumns: ["equipment_id"]
          ...
          {
            foreignKeyName: "press_daily_logs_operator_id_fkey"
            columns: ["operator_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["employee_id"]
          ...
          {
            foreignKeyName: "press_daily_logs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["product_id"]
      ...
      transport_daily_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "transport_daily_logs_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["employee_id"]
    ...
    Functions: {
      ...
      fn_transition_product_lifecycle: {
        Args: {
          p_changed_by?: string
          p_metadata?: Json
          p_product_id: string
      ...
      generate_wo_code: { Args: never; Returns: string }
      hide_company: {
        Args: { p_company_id: string; p_user_id: string }
        Returns: undefined
      }
      promote_company_to_ssot: {
        Args: { p_company_id: string; p_user_id: string }
        Returns: undefined
      }
      remap_company_fks: {
