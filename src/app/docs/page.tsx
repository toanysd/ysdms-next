...
export const metadata = {
  title: 'システム設計書 & 業務仕様 | YSDMS NextGen',
}
    ...
    <div className="flex flex-col h-full bg-slate-50">
      ...
      <div className="bg-white px-6 py-4 border-b border-slate-200 flex items-center justify-between shrink-0 shadow-sm z-10 relative">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800">システム設計書</h1>
            <p className="text-xs text-slate-500 mt-0.5">YSDMS NextGen のエンティティモデル・業務フロー・標準操作ガイド</p>
          </div>
        </div>
      </div>
