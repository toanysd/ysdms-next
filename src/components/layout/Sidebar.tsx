...
const MENU_ITEMS = [
  ...
  { href: '/maintenance', icon: Wrench, labelJA: '金型メンテナンス', labelVI: 'Bảo trì Khuôn' },
  ...
  { href: '/production/molds/designs', icon: FileText, labelJA: '金型設計', labelVI: 'Thiết kế Khuôn' },
  { href: '/production/molds', icon: Layers, labelJA: '金型在庫', labelVI: 'Tồn kho Khuôn' },
