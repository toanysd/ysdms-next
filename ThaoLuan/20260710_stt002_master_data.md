...
> [!IMPORTANT]
> `㈱サンテック東北` hiện có trong DB nhưng `company_code = 'STT-001.xlsx'` → **CẦN SỬA thành `STT`**
> `company_id = 9de61fba-0730-4baa-8b87-d2933f48b187`
...
> [!NOTE]
> Hiện DB đã có `product_code = 'STT002'` (thiếu `AB`). Cần **cập nhật** thành `STT002AB`, `product_name_internal` thành `STT-002AB`.
> `product_id = f4a1ba32-a890-4ca8-9d35-80fb7ac59c1a`
...
| step_no | track | item_type | step_name | processing_code | est_hours | deadline | outsource |
|---------|-------|-----------|-----------|-----------------|-----------|----------|-----------|
| 1 | MOLD | MOLD (2) | 裏面プログラム | 本型演算＆加工 (10) | 3h | 2026-06-27 | — |
| 2 | MOLD | MOLD (2) | 裏面加工 | 本型演算＆加工 (10) | 5h | 2026-06-28 | — |
| 3 | MOLD | MOLD (2) | 表面プログラム | 本型演算＆加工 (10) | 2h | 2026-06-28 | — |
| 4 | MOLD | MOLD (2) | 表面加工 | 本型演算＆加工 (10) | 120h | 2026-07-08 | — |
| 5 | MOLD | MOLD (2) | 金型穴あけ | 本型穴あけ (11) | 4h | 2026-07-09 | — |
| 6 | MOLD | MOLD (2) | 磨き・仕上げ | 磨き・仕上げ (12) | 4h | 2026-07-10 | — |
| 7 | MOLD | MOLD (2) | 洗浄・刻印 | 洗浄・刻印 (13) | 2h | 2026-07-11 | — |
| 8 | PLUG | PLUG (3) | プラグ加工 | プラグ演算＆加工 (31) | 5h | 2026-07-05 | — |
| 9 | PLUG | PLUG (3) | ベース切断・ネル貼り | 本型手造りプラグ (33) | 4h | 2026-07-07 | — |
| 10 | CUTTER | CUTTER (4) | 外注手配 | カッター治具 (43) | 0h | 2026-07-05 | ✅ 外注 |
| 11 | CUTTER | CUTTER (4) | 抜型受取 | カッター治具 (43) | 1h | 2026-07-13 | — |
...
> [!NOTE]
> Mã 【405】dùng trong prototype #2 (mail 2026-05-19). Mã 【640】dùng cho production chính thức (mail 2026-07-03).
> Có thể 405 và 640 là cùng loại nhựa nhưng khác mã nhà cung cấp / lô hàng. ⚠️ CẦN XÁC NHẬN.
...
## 12. GHI CHÚ KINH DOANH QUAN TRỌNG
...
| Khắc khuôn | Rubycon logo, リサイクルマーク, TR-S24, A hoặc B |
