...
test('Order Creation Flow', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/Users/WIN10MST/.gemini/antigravity/after_submit_part2.png' });
    ...
    await page.getByText(trayDesignSlip).first().waitFor({ state: 'visible', timeout: 15000 });
});
